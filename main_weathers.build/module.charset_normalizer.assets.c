...
/* The "module_charset_normalizer$assets" is a Python object pointer of module type.
 *
...
PyObject *module_charset_normalizer$assets;
...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("charset_normalizer.assets"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_charset_normalizer$assets(void) {
...
static PyCodeObject *codeobj_eaf2a93fea51440120f4ef63ba771789;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[22]); CHECK_OBJECT(module_filename_obj);
    codeobj_eaf2a93fea51440120f4ef63ba771789 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[23], mod_consts[23], NULL, NULL, 0, 0, 0);
}
...
function_impl_code functable_charset_normalizer$assets[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_charset_normalizer$assets;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_charset_normalizer$assets) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_charset_normalizer$assets[offset],
        code_object->co_name,
...
#endif
        module_charset_normalizer$assets,
        doc,
        NULL,
        0
    );
...
PyObject *modulecode_charset_normalizer$assets(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("charset_normalizer.assets");

    // Store the module for future use.
    module_charset_normalizer$assets = module;
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("charset_normalizer.assets: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("charset_normalizer.assets: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("charset_normalizer.assets: Calling createModuleCodeObjects().\n");
#endif
    ...
    // PRINT_STRING("in initcharset_normalizer$assets\n");

    moduledict_charset_normalizer$assets = MODULE_DICT(module_charset_normalizer$assets);
    ...
    CHECK_OBJECT(module_charset_normalizer$assets);

    // For deep importing of a module we need to have "__builtins__", so we set
    // it ourselves in the same way than CPython does. Note: This must be done
    // before the frame object is allocated, or else it may fail.

    if (GET_STRING_DICT_VALUE(moduledict_charset_normalizer$assets, (Nuitka_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_charset_normalizer$assets, (Nuitka_StringObject *)const_str_plain___builtins__, value);
    }

#if PYTHON_VERSION >= 0x300
    UPDATE_STRING_DICT0(moduledict_charset_normalizer$assets, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_charset_normalizer$assets, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_charset_normalizer$assets);
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_charset_normalizer$assets, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
    ...
    struct Nuitka_FrameObject *frame_eaf2a93fea51440120f4ef63ba771789;
    ...
    // owning it.
    pushFrameStack(frame_eaf2a93fea51440120f4ef63ba771789);
    assert(Py_REFCNT(frame_eaf2a93fea51440120f4ef63ba771789) == 2);
    ...
    // Framed code:
    {
        ...
        frame_eaf2a93fea51440120f4ef63ba771789->m_frame.f_lineno = 1;
        {
    ...
    } else if (exception_tb->tb_frame != &frame_eaf2a93fea51440120f4ef63ba771789->m_frame) {
    ...
    PGO_onModuleExit("charset_normalizer.assets", false);

    Py_INCREF(module_charset_normalizer$assets);
    return module_charset_normalizer$assets;
